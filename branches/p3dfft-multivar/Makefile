...
ACLOCAL = ${SHELL} /global/homes/d/dmitryp/p3dfft.2.7.1/svn/missing --run aclocal-1.9
AMTAR = ${SHELL} /global/homes/d/dmitryp/p3dfft.2.7.1/svn/missing --run tar
AUTOCONF = ${SHELL} /global/homes/d/dmitryp/p3dfft.2.7.1/svn/missing --run autoconf
AUTOHEADER = ${SHELL} /global/homes/d/dmitryp/p3dfft.2.7.1/svn/missing --run autoheader
AUTOMAKE = ${SHELL} /global/homes/d/dmitryp/p3dfft.2.7.1/svn/missing --run automake-1.9
AWK = gawk
CC = cc
CDFLAGS = -DMEASURE -DFFTW
CFLAGS = -g
CPP = cc -E
CPPFLAGS = 
CYGPATH_W = echo
...
FC = ftn
FCFLAGS = -ef -em -g
FDFLAGS = -DMEASURE -DFFTW
FFTWF = 
FFTW_INC = -I/opt/fftw/3.2.2.1/lib/../include
FFTW_LIB = /opt/fftw/3.2.2.1/lib/../lib/libfftw3.a
FORTRAN_LIB = 
...
LIBS = 
LTLIBOBJS = 
MAKEINFO = ${SHELL} /global/homes/d/dmitryp/p3dfft.2.7.1/svn/missing --run makeinfo
OBJEXT = o
PACKAGE = p3dfft
PACKAGE_BUGREPORT = dmitry@sdsc.edu
PACKAGE_NAME = P3DFFT
PACKAGE_STRING = P3DFFT 2.6
...
install_sh = /global/homes/d/dmitryp/p3dfft.2.7.1/svn/install-sh
...
distdir: $(DISTFILES)
	$(am__remove_distdir)
	mkdir $(distdir)
	$(mkdir_p) $(distdir)/build $(distdir)/include
